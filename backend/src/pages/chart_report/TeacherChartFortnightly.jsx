...
const TeacherChartFortnightly = () => {
  const {data: attendances = []} = useQuery([
    "teacher/chart/fortnightly",
  ], {
    queryFn: async () => {
      return await new API().getTeacherChartFortnightly();
    }
  });
          ...
          <div className="reportsContainer">
            <div className="reportsSection">
              <div className="datatable">
                <Link to="/teacher_report" className="backButtonSection">
                  <KeyboardBackspaceIcon className="backButton"/>
                </Link>
                <br/>
                <br/>
                <div className="datatableTitle">
                  Teacher Fortnightly Report
                </div>
                <br/>
...
export default TeacherChartFortnightly;
