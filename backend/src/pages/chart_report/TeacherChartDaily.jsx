...
const TeacherChartDaily = () => {
  const [target, setTarget] = useState(moment(new Date()).format("YYYY-MM-DD"));
  const {data: attendances = []} = useQuery([
    "teacher/chart/daily", target,
  ], {
    queryFn: async () => {
      return await new API().getTeacherChartDaily(target);
    }
  });
...
export default TeacherChartDaily;
