...
const NonTeacherChartMonthly = () => {
  const [target, setTarget] = useState(2024);
  const {data: attendances = []} = useQuery([
    "non-teacher/chart/monthly", target,
  ], {
    queryFn: async () => {
      return await new API().getNonTeacherChartMonthly(target);
    }
  });
...
export default NonTeacherChartMonthly;
